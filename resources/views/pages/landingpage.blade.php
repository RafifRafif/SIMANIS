...
@section('content')
    ...
    <section class="hero d-flex flex-column justify-content-center align-items-center">
        ...
        <h4 class="fw-bold mb-0" style="margin-top: -10px;">Sistem Manajemen Risiko Polibatam</h4>
    ...
    <!-- Section Kontak -->
    <section id="kontak" class="py-5" style="background-color:white;border-radius: 80px 80px 0 0; margin: 0;">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 offset-md-1" style="margin-left: -60px;">
                    <div class="mb-3 d-flex align-items-center shadow-sm p-2 rounded" style="background-color: #D9D9D9;">
