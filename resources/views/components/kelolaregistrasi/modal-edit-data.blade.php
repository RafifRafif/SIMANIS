                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="#" method="POST">
                                ...
                                <div class="mb-4">
                                    <label for="edit-jenis_risiko" class="form-label">Jenis Risiko</label>
                                    <select class="form-select" id="edit-jenis_risiko" name="jenis_risiko" required>
                                ...
                                <div class="mb-4">
                                    <label for="edit-jenis" class="form-label">jenis Isu</label>
