<!-- Modal Hapus Data Jenis Risiko -->
<div class="modal fade" id="hapusJenisRisikoModal" tabindex="-1" aria-labelledby="hapusJenisRisikoLabel" aria-hidden="true">
...
<script>
  document.addEventListener('DOMContentLoaded', () => {
    document.querySelectorAll('.delete-jenis-button').forEach(button => {
      button.addEventListener('click', function() {
        const id = this.dataset.id;
        document.getElementById('deleteJenisForm').action = `/jenis/delete/${id}`;
      });
    });
  });
</script>
