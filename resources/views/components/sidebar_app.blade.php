{{-- Sidebar App CSS --}}
<link rel="stylesheet" href="{{ asset('css/sidebar_app.css') }}">
  ...
  <div class="sidebar" id="sidebar">
    ...
    <a href="#"><i class="fa-solid fa-gear"></i> Kelola Beranda</a>
    <a href="#"><i class="fa-solid fa-folder"></i> Kelola Form Regis</a>
    <a href="#"><i class="fa-solid fa-users"></i> Kelola Pengguna</a>
</div>